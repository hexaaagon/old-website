...
const navbar = (
  <div>
    ...
    <nav className="relative px-4 py-6 flex justify-between items-center bg-gray-300 dark:bg-gray-800 lg:hover:scale-[102%] bg-gradient-to-br ease-in-out duration-100">
    ...
    <div className="navbar-menu relative z-[99] hidden">
      ...
      <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-gradient-to-br from-emerald-500 to-gray-400 dark:to-gray-900 border-r overflow-y-auto">
